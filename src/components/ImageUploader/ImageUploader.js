      ...
      <View>
        <View>
          ...
          <Text style={{textAlign: 'center'}}>
            {`Current Upload ID: ${
              this.state.uploadId === null ? 'none' : this.state.uploadId
            }`}
          </Text>
          <Text style={{textAlign: 'center'}}>
            {`Progress: ${
              this.state.progress === null ? 'none' : `${this.state.progress}%`
            }`}
          </Text>
          <View />
          <Button title="Tap to Cancel Upload" onPress={this.cancelUpload} />
        </View>
      </View>
    );
  }
